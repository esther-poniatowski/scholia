...
% - local repository builds can still define \CommonPath themselves and use it
%   in the package path if convenient
...
\scholia provides explicit listing helpers and intentionally does not set a
global default for the \pkg{listings} package. This avoids hidden inheritance
when documents define their own local listing styles.

\textbf{Generic code block with Scholia's neutral listing style:}
